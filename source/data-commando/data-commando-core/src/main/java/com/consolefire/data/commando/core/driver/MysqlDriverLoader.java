...
public class MysqlDriverLoader implements DriverLoader {
  ...
  private static final DriverContainer DRIVER_CONTAINER = DriverContainer.getContainer();
  ...
  @Override
  public DriverInfo load(String name, String fileName) throws UnsupportedDriverException {
    return load(fileName, new File(fileName));
  }

  @Override
  public DriverInfo load(String name, File file) throws UnsupportedDriverException {
