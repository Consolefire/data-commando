 ...
 * @author sabuj.das
 */
public class DataCommandoUiContext {
    private static DataCommandoUiContext context;
    private AppSettings appSettings;

    private DataCommandoUiContext() {
     ...
     * @return the context
     */
    public static DataCommandoUiContext getContext() {
        if (null != context) {
            return context;
        }
        synchronized (DataCommandoUiContext.class) {
            context = new DataCommandoUiContext();
        }
        return context;
    }
    ...
    public void initContext() {
        File settingsFile = new File(DataCommandoUiConstants.SETTINGS_FILE_NAME);
